...
const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: <Storage />,
    children: [
      { title: 'Distribution', path: '/debian/distribution', icon: <Cloud /> },
      { title: 'Publication', path: '/debian/publication', icon: <Article /> },
      { title: 'Remote', path: '/debian/remote', icon: <Cloud /> },
      { title: 'Repository', path: '/debian/repository', icon: <Folder /> },
    ],
  },
];
