...
const REPOSITORIES_ENDPOINT = '/repositories/deb/apt/';
const REMOTES_ENDPOINT = '/remotes/deb/apt/';
const DISTRIBUTIONS_ENDPOINT = '/distributions/deb/apt/';
const PUBLICATIONS_ENDPOINT = '/publications/deb/apt/';

export const debService = {
  repositories: {
