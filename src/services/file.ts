...
const REPOSITORIES_ENDPOINT = '/repositories/file/file/';
const REMOTES_ENDPOINT = '/remotes/file/file/';
const DISTRIBUTIONS_ENDPOINT = '/distributions/file/file/';
const PUBLICATIONS_ENDPOINT = '/publications/file/file/';
